...
The tension between generic and specialized systems is a recurring one in systems research. Generic runtimes amortize engineering effort but pay a *portability tax*, since abstractions that fit every target rarely fit any target perfectly. Operating systems work has traditionally tried to push toward specialization (e.g., the [*Synthesis* kernel](https://dl.acm.org/doi/10.1145/74850.74869), [*exokernels*](https://dl.acm.org/doi/10.1145/224056.224076), and [*unikernels*](https://dl.acm.org/doi/10.1145/2451116.2451167)), but per-target engineering cost has kept specialization out of the mainstream.
